...
const STATS = [
    {
        icon: <FontAwesomeIcon icon={faBriefcase} className="text-[#BC2228] text-3xl" />,
        label: "Live Job",
        count: "1,75,324",
        bg: "bg-white",
        active: false,
    ...
    {
        icon: <FontAwesomeIcon icon={faCity} className="text-white text-3xl" />,
        label: "Companies",
        count: "97,354",
        bg: "bg-[#CC1E1E]",
        text: "text-white",
    ...
    {
        icon: <FontAwesomeIcon icon={faPeopleGroup} className="text-[#BC2228] text-3xl" />,
        label: "Candidates",
        count: "38,47,154",
        bg: "bg-white",
        active: false,
    ...
    {
        icon: <FontAwesomeIcon icon={faSquareArrowUpRight} className="text-[#BC2228] text-3xl" />,
        label: "New Jobs",
        count: "7,532",
        bg: "bg-white",
        active: false,
...
const TESTIMONIALS = [
    ...
    },
    {
        ...
        text: "Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Suspendisse et magna quis nibh accumsan.",
    },
    {
        id: 4,
        name: "Sơn Việt",
        role: "Software Engineer",
        avatar: "https://i.pravatar.cc/150?u=viet",
        text: "Hệ thống tìm việc cực kỳ chuyên nghiệp và giao diện rất dễ sử dụng. Rất đáng trải nghiệm!",
    },
    {
        id: 5,
        name: "Mai Anh",
        ...
        text: "Tôi rất hài lòng với chất lượng ứng viên tìm được qua nền tảng này. Cảm ơn RikkeiEdu!",
    },
];

const company_data = Array(9).fill({
    name: "Dribbble",
    featured: true,
    level: "Fresher",
...
const candidate_data = Array(9).fill({
    name: "Nguyen Van A",
    position: "Front-end",
    level: "Fresher",
...
export const HomepageMain = () => {
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            setCurrentIndex((prev) => (prev >= TESTIMONIALS.length - itemsPerView ? 0 : prev + 1));
        }, 4000);
        ...
        <div className="min-h-screen bg-white font-sans text-gray-900">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-6 -mt-14 relative z-10">
                {STATS.map((stat, i) => (
                    <div
                        key={i}
                        className={`${stat.bg} p-6 rounded-xl shadow-xl flex items-center gap-5 border border-gray-50 hover:-translate-y-2 transition-transform duration-300`}
                    >
