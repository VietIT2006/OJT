  ...
  <div className="">
    <div className="flex flex-wrap items-center gap-4">
      <div className="flex flex-1 min-w-[320px] min-h-[60px] items-center rounded-[1px] border border-[#ececec] bg-white text-sm text-[#8a8a8a]">
        ...
        <div className="relative flex flex-1 min-w-[200px] gap-3 px-4 py-3">
        ...
        <div className="flex gap-3 mr-3">
          <button
            ...
            className="flex items-center gap-2 rounded-[4px] bg-[#F1F2F4] px-4 py-2 text-sm font-semibold text-[#505050]"
          >
            <img src={sliderIcon} alt="Filters" className="h-4 w-4" />
            Filters
          </button>
          <button className="rounded-[4px] bg-[#BC2228] px-4 py-2 text-sm font-semibold text-white" type="button" onClick={onSubmit}>
            Find Job
          </button>
        </div>
      </div>
