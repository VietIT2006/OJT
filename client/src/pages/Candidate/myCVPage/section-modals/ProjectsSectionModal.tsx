...
const ProjectsSectionModal = ({ section, saving, onCancel, onSave }: Props) => {
  ...
  const handleChange = (field: keyof ProjectData) => (event: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) =>
  ...
  return (
    <div className="w-full max-w-4xl rounded-2xl bg-white p-8 shadow-2xl">
      <h1 className="mb-8 text-center text-3xl font-bold">Dự án cá nhân</h1>

      <div className="mb-8 space-y-6">
        <div>
          <label className="mb-2 block text-gray-700">Tên dự án</label>
          <input
            type="text"
            value={data.name}
        ...
        <div>
          <label className="mb-2 block text-gray-700">Link demo</label>
          <input
            type="text"
            value={data.link}
        ...
        <div>
          <label className="mb-2 block text-gray-700">Thời gian thực hiện</label>
