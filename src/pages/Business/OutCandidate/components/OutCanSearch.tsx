            ...
            {openFilter && (
                <div className="bg-white rounded-lg shadow border border-gray-400 p-4 mb-6">
                    <div className="flex flex-wrap justify-around gap-2 items-center">
                        <Select className="border-0! rounded-0! bg-[#F1F2F4]!" size="large" placeholder="Kinh Nghiệm" allowClear />
                        <Select className="border-0! rounded-0! bg-[#F1F2F4]!" size="large" placeholder="Công Nghệ Sử Dụng" allowClear />
                        <Select className="border-0! rounded-0! bg-[#F1F2F4]!" size="large" placeholder="Ngoại Ngữ" allowClear />
                        <Select className="border-0! rounded-0! bg-[#F1F2F4]!" size="large" placeholder="Vị Trí" allowClear />
